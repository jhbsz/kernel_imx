...
#warning FIXME: max8971 api definition
static int max8971_charger_online(void){return 0;}
static int max8971_wakelock_status(void){return 0;}
static int max8971_check_temperature(void){return 0;}
static int max8971_check_battery_details(void){return 0;}
static int max8971_check_charger_details(void){return 0;}
			...
			const struct i2c_device_id *id)
{
	...
	#warning FIXME:  Add lowbat trigger irq????
