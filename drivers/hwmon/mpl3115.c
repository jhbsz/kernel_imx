 ...
 *
 *  Copyright (C) 2010-2011 Freescale , Inc. All Rights Reserved.
 *
...
static int __devinit mpl3115_probe(struct i2c_client *client,
...
static int __devexit mpl3115_remove(struct i2c_client *client)
{
...
static struct i2c_driver mpl3115_driver = {
	...
	.probe = mpl3115_probe,
	.remove = __devexit_p(mpl3115_remove),
	.id_table = mpl3115_id,
};
...
static int __init mpl3115_init(void)
{
	...
	if (res < 0) {
		printk(KERN_INFO "add mpl3115 i2c driver failed\n");
		return -ENODEV;
	}
	return res;
}
