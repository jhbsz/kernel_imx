...
static iomux_v3_cfg_t mx6q_sparkauto_pads[] = {
	...
	*/
	...
	MX6Q_PAD_SD3_RST__GPIO_7_8,		/* SD3_CD */
	...
	(MX6Q_PAD_ENET_RXD0__ENET_RDATA_0&(~MUX_PAD_CTRL_MASK))|MUX_PAD_CTRL(MX6Q_ENET_PAD_CTRL),/*FOR LAN8720 MODE control*/
	(MX6Q_PAD_ENET_RXD1__ENET_RDATA_1&(~MUX_PAD_CTRL_MASK))|MUX_PAD_CTRL(MX6Q_ENET_PAD_CTRL),
	(MX6Q_PAD_ENET_CRS_DV__ENET_RX_EN&(~MUX_PAD_CTRL_MASK))|MUX_PAD_CTRL(MX6Q_ENET_PAD_CTRL),
	(MX6Q_PAD_ENET_TXD0__ENET_TDATA_0&(~MUX_PAD_CTRL_MASK))|MUX_PAD_CTRL(MX6Q_ENET_PAD_CTRL),
	(MX6Q_PAD_ENET_TXD1__ENET_TDATA_1&(~MUX_PAD_CTRL_MASK))|MUX_PAD_CTRL(MX6Q_ENET_PAD_CTRL),
	(MX6Q_PAD_ENET_TX_EN__ENET_TX_EN&(~MUX_PAD_CTRL_MASK))|MUX_PAD_CTRL(MX6Q_ENET_PAD_CTRL),
	(MX6Q_PAD_ENET_RX_ER__GPIO_1_24&(~MUX_PAD_CTRL_MASK))|MUX_PAD_CTRL(MX6Q_ENET_PAD_CTRL), /* set phy addr */
	(MX6Q_PAD_GPIO_16__ENET_ANATOP_ETHERNET_REF_OUT&(~MUX_PAD_CTRL_MASK))|MUX_PAD_CTRL(MX6Q_ENET_REF_CLK_PAD_CTRL),	
	MX6Q_PAD_EIM_A24__GPIO_5_4, /* reset phy */
