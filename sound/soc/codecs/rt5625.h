...
#define RT5625_DAC_AND_MIC_CTRL		0X10	/* stereo dac and mic route ctrl */
...
#define RT5625_DAC_ADC_VODAC_FUN_SEL	0X2E	/* stereo/voice dac select */
#define	RT5625_MAIN_SDP_CTRL		0X34	/* main serial data port ctrl */
#define RT5625_EXTEND_SDP_CTRL		0X36	/* extend serial data port ctrl */
...
#define RT5625_GEN_CTRL_REG1		0X40	/* general purpose control 1 */
#define	RT5625_GEN_CTRL_REG2		0X42	/* general purpose control 2 */
...
#define	RT5625_OVER_TEMP_CURR_STATUS	0X58	/* over temp & current status */
#define RT5625_SOFT_VOL_CTRL		0X5A	/* soft volume ctrl */
#define RT5625_GPIO_OUT_CTRL		0X5C	/* gpio output pin contrl */
#define RT5625_MISC_CTRL		0X5E	/* misc control */
#define	RT5625_STEREO_DAC_CLK_CTRL1	0X60	/* stereo dac clock ctrl 1 */
#define RT5625_STEREO_DAC_CLK_CTRL2	0X62	/* stereo dac clock ctrl 2 */
#define RT5625_VOICE_DAC_PCMCLK_CTRL1	0X64	/* voice/pcm dac clock ctrl 1 */
...
/* speaker output volume (0x02) */
#define M_SPK_L				(0x1<<15)	/* Mute left speak control */
#define M_SPK_R				(0x1<<7)	/* Mute right speak control */

/* headphone output volume (0x04) */
#define M_HP_L				(0x1<<15)	/* Mute left HP */
#define M_HP_R				(0x1<<7)	/* Mute left HP */
...
#define M_LINEIN_TO_HP_MIXER		(0x1<<15)	/* Mute Phone In volume to HP mixer */
#define M_LINEIN_TO_SPK_MIXER		(0x1<<14)	/* Mute Phone In volume to speaker mixer */

/* stereo dac volume (0x0c) */
#define M_MAIN_L_INPUT			(0x1<<15)	/* Mute Phone In volume to HP mixer */
#define M_MAIN_R_INPUT			(0x1<<7)	/* Mute Phone In volume to speaker mixer */

/* Mic input volume (0x0c) */
#define MIC1_DIFF_CTRL			(0x1<<15)	/* MIC1 Use Differential Input */
#define MIC2_DIFF_CTRL			(0x1<<7)	/* MIC2 Use Differential Input */
...
/* power down control of register (0x26) */
...
#define PWR_SPK_L_OUT_VOL		(0x1<<13)
#define PWR_SPK_R_OUT_VOL		(0x1<<12)
...
enum rt5625_aec_mode {
	RT5625_VODSP_AEC_DISABLE=0,
	RT5625_PCM_IN_PCM_OUT,
	RT5625_ANALOG_IN_ANALOG_OUT,
	RT5625_DAC_IN_ADC_OUT,
};
