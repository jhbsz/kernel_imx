...
static int rt5633_volatile_register(
...
static int rt5633_readable_register(
	struct snd_soc_codec *codec, unsigned int reg)
{
	switch (reg) {
	case RT5633_RESET:
...
static int rt5633_probe(struct snd_soc_codec *codec)
{
	...
	ret = snd_soc_codec_set_cache_io(codec, 8, 16, rt5633->control_type);
	if (ret != 0) {
	...
	snd_soc_dapm_new_controls(&codec->dapm, rt5633_dapm_widgets,
			ARRAY_SIZE(rt5633_dapm_widgets));
	snd_soc_dapm_add_routes(&codec->dapm, rt5633_dapm_routes,
...
static struct snd_soc_codec_driver soc_codec_dev_rt5633 = {
	...
	.reg_cache_size = RT5633_VENDOR_ID2 + 1,
	.reg_word_size = sizeof(u16),
	.reg_cache_default = rt5633_reg,
	.volatile_register = rt5633_volatile_register,
	.readable_register = rt5633_readable_register,
	.reg_cache_step = 1,
};
...
static int __devinit rt5633_i2c_probe(struct i2c_client *i2c,
...
static int __devexit rt5633_i2c_remove(struct i2c_client *i2c)
{
...
static int rt5633_i2c_shutdown(struct i2c_client *client)
{
